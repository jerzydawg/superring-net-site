...
const MOBILE_MENU_CTA_VARIATIONS = [
  ...
  'Get Free Service', 'Apply Now Free', 'Claim Free Service', 'Begin Enrollment',
...
// Navigation order variations (different arrangements)
const NAV_ORDER_VARIATIONS = [
  ['home', 'programs', 'eligibility', 'providers', 'faq', 'contact'],
  ['home', 'eligibility', 'programs', 'providers', 'faq', 'contact'],
  ['home', 'programs', 'providers', 'eligibility', 'faq', 'contact'],
  ['home', 'eligibility', 'providers', 'programs', 'faq', 'contact'],
  ['home', 'providers', 'programs', 'eligibility', 'faq', 'contact'],
  ['home', 'providers', 'eligibility', 'programs', 'faq', 'contact'],
  ['home', 'programs', 'eligibility', 'faq', 'providers', 'contact'],
  ['home', 'eligibility', 'programs', 'faq', 'providers', 'contact'],
  ['home', 'faq', 'programs', 'eligibility', 'providers', 'contact'],
  ['home', 'faq', 'eligibility', 'programs', 'providers', 'contact'],
  ['home', 'programs', 'faq', 'eligibility', 'providers', 'contact'],
  ['home', 'eligibility', 'faq', 'programs', 'providers', 'contact'],
  ['home', 'programs', 'eligibility', 'contact', 'providers', 'faq'],
];
...
export function getNavVariations(domain: string): NavVariations {
  ...
  // Build nav items with varied labels
  const navLabels: Record<string, { labels: string[]; href: string }> = {
    ...
    contact: { labels: NAV_CONTACT_LABELS, href: '/contact' },
  };
